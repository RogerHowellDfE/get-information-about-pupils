...
namespace DfE.GIAP.Web.Controllers.LearnerNumber
{
    ...
    public class FELearnerNumberController : BaseLearnerNumberController
    {
        ...
        public override string FullTextLearnerSearchController => Global.FurtherEducationLearnerTextSearchController;
        public override string FullTextLearnerSearchAction => Global.FurtherEducationLearnerTextSearchAction;
        ...
        [Route(Route.FurtherEducation.LearnerNumberSearch)]
        [HttpGet]
