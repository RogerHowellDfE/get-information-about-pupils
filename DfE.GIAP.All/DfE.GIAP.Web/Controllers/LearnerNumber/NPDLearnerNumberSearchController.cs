...
namespace DfE.GIAP.Web.Controllers.LearnerNumber
{
    ...
    public class NPDLearnerNumberSearchController : BaseLearnerNumberController
    {
        ...
        public override string FullTextLearnerSearchAction => Route.NationalPupilDatabase.NationalPupilDatabaseNonUPN;
        ...
        [Route(Route.NationalPupilDatabase.NationalPupilDatabaseLearnerNumber)]
        [HttpGet]
        ...
        [HttpPost]
        [Route(Route.NPDInvalidUPNsConfirmation)]
